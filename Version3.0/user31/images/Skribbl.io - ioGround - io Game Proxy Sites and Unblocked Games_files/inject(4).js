(function() {
  if (window.top === window.self) {
    ...
    const saReport = function () {
      ...
      xhr.open('POST', document.location.origin + '/c783231b10f15016836773b2146780d31c513fdfe7de6450b5d3bdd46a33d98b/log', true);
    ...
    if (window.location.href.match(/(^|\.)youtube\./)) {
      ...
      const applyYouTube = function () {
        ...
        xhr.open('POST', document.location.origin + '/c783231b10f15016836773b2146780d31c513fdfe7de6450b5d3bdd46a33d98b/ytconf', true);
        xhr.send(JSON.stringify(body));
      ...
      const blockYTImg = '/c783231b10f15016836773b2146780d31c513fdfe7de6450b5d3bdd46a33d98b/blocked-yt-image.png';
...
class Flags {
  ...
  Report(flags) {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open('POST', document.location.origin + '/c783231b10f15016836773b2146780d31c513fdfe7de6450b5d3bdd46a33d98b/log_flag', true);
